      ...
      <div className="flex gap-1 border-b border-slate-200 mb-5">
        <button
          ...
          className={`px-3.5 py-2.5 text-sm font-medium border-b-2 -mb-px transition-colors ${
            tab === "incidents" ? "border-accent-600 text-accent-600" : "border-transparent text-slate-500 hover:text-slate-800"
          }`}
        >
          Incidents
        </button>
        <button
          ...
          className={`px-3.5 py-2.5 text-sm font-medium border-b-2 -mb-px transition-colors ${
            tab === "estimator" ? "border-accent-600 text-accent-600" : "border-transparent text-slate-500 hover:text-slate-800"
          }`}
        >
          Cost Estimator
        </button>
        {showPatterns && (
          <button
            ...
            className={`px-3.5 py-2.5 text-sm font-medium border-b-2 -mb-px transition-colors ${
              tab === "patterns" ? "border-accent-600 text-accent-600" : "border-transparent text-slate-500 hover:text-slate-800"
            }`}
          >
            Incident Patterns
          </button>
