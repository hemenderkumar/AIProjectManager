...
// TOTP (RFC 6238) enrollment/verification for the ProjectRequesta roles the spec mandates MFA
// for -- Client Finance Approver and every Platform role (see MFA_REQUIRED_ROLES in
// access.ts, and the enforcement wired into requirePrPlatform/requirePrOrgRole there). Works
