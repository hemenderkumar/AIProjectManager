...
> = {
  ...
  project: {
    ...
    fields: [
      ...
      { key: "businessCaseExecutiveSummary", label: "Executive summary (Financial Forecast & Projections)", kind: "text" },
      { key: "swotStrengths", label: "SWOT: Strengths", kind: "text" },
      { key: "swotWeaknesses", label: "SWOT: Weaknesses", kind: "text" },
      { key: "swotOpportunities", label: "SWOT: Opportunities", kind: "text" },
      { key: "swotThreats", label: "SWOT: Threats", kind: "text" },
      { key: "marketAnalysis", label: "Market analysis", kind: "text" },
      { key: "marketPrediction", label: "Market prediction", kind: "text" },
