...
import { StylePresetPicker } from "@/components/ContentTemplatePicker";
...
export default function ReportsPage() {
  ...
  async function generate(type: string) {
    ...
    const res = await fetch("/api/reports/generate", {
      ...
      body: JSON.stringify({ type, templateId: styleTemplateId || undefined }),
    });
    setGenerating(null);
    if (res.ok) {
      ...
      <Topbar
        ...
        action={
          <div className="flex items-center gap-3">
            <StylePresetPicker entityType="STATUS_REPORT" value={styleTemplateId} onChange={setStyleTemplateId} />
            <button
