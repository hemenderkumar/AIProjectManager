...
import { LayoutTemplate, Rocket, Sparkles, Loader2, X, RotateCcw } from "lucide-react";
...
export default function TemplatesPage() {
  ...
  // AI-tweak state, keyed by template id -- editing one template's instruction/preview
  // doesn't touch any other card's state.
