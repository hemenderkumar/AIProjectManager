    ...
    <div className="min-h-screen bg-white">
      ...
      {user ? (
        <section className="max-w-6xl mx-auto px-6 pt-20 pb-16 text-center">
          <p className="text-xs font-medium tracking-widest uppercase text-indigo-600 mb-4">Welcome back, {user.name.split(" ")[0]}</p>
          <h1 className="text-3xl sm:text-4xl font-semibold text-slate-900 leading-tight tracking-tight mb-5 max-w-2xl mx-auto">
            Pick up where you left off.
          </h1>
          <p className="text-base text-slate-500 mb-8 max-w-lg mx-auto">
            Your projects, budgets, and reports are waiting in the tracker.
          </p>
          <Link
            href="/home"
            className="inline-block text-sm font-medium px-6 py-3 rounded-lg bg-indigo-600 text-white shadow-sm shadow-indigo-600/20 hover:bg-indigo-700 transition-colors"
          >
            Go to the Tracker
          </Link>
        </section>
