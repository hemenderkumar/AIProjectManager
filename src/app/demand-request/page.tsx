...
export default function DemandRequestPage() {
  const [form, setForm] = useState({ title: "", description: "", expectedOutcome: "", requestedByName: "", requestedByEmail: "" });
        ...
        {submitted ? (
          ...
          <>
            ...
            <form onSubmit={submit} className="space-y-3">
              ...
              <textarea
                required
                placeholder="Business problem — what's going wrong, and why now?"
              ...
              />
              <textarea
                placeholder="Expected outcome (optional) — what does success look like?"
