...
export const metadata: Metadata = {
  title: "ProjectRequesta Marketplace — Open Projects & Resource Requests | Executa",
  description:
    "Browse open outsourcing projects and staffing requests posted on the ProjectRequesta marketplace. No login required to browse — sign up to bid.",
};
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="max-w-5xl mx-auto px-6 py-12">
        ...
        <p className="text-sm text-slate-600 max-w-2xl mb-6">
          Every posting below is open on ProjectRequesta right now. Browse freely — create a free Vendor
