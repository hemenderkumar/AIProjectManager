// Minimal service worker whose only job is to make Executa installable to a phone's home
// screen — Chrome's installability check requires a registered service worker with a
// `fetch` handler, but Executa is a fully authenticated, live-data app (session cookies,
